...
var TwoWayDropNode = require('../common/element/dropnodetwoway.jsx');
...
module.exports = React.createClass({
    ...
    onDragStart: function(e) {
        e.dataTransfer.setData('PropertyKey', this.pathString);
    },
    getDropData: function(e) {
        var dropData = e.dataTransfer.getData('PropertyKey');
    ...
    onRemove: function(e) {
        this.props.dplBuilder.formatControl.select.removeProp(this.props.config.path[this.props.config.path.length - 1]);
        this.props.dplBuilder.selectFormula('', null);
    },
    render: function() {
        ...
        if(this.state.modify == 1) {
            ...
            switch (this.state.focusState) {
                case 1:
                    ...
                    break;
                case 2:
                    innerContent.push(<TwoWayDropNode key='dropnode' onDropUp={this.onDropUp} onDropDown={this.onDropDown} dragInfo={this.dragInfo} />);
                    break;
            }
        }
