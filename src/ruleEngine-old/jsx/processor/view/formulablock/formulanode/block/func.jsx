...
var FuncSelector = require('../part/funcselector');
    ...
    render: function() {
        ...
        return (
            <span className={className} draggable='true' onDragStart={this.onDragStart} onDragEnd={this.onDragEnd} onClick={this.onClick}>
                <FuncSelector control={this.props.control} formulaControl={this.props.dplBuilder.formulaControl} onUpdate={this.onUpdate} keyActionHandler={this.props.keyActionHandler}/>
                {this.props.control.config.params.map(function(config, index) {
                    return self.props.formulaFactory.create(index, index, config, self.props.control, self.props.dplBuilder, false, self.props.keyActionHandler)
                })}
